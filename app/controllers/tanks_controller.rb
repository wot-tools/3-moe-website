class TanksController < ApplicationController
	...
	def index
		...
		@tanks = @q.result.includes(:nation, :vehicle_type).paginate(:page => params[:page], :per_page => 20)
	end
	...
	def show
		...
		@marks = @q.result.distinct.includes(:player, player: [:clan]).paginate(:page => params[:page], :per_page => 20)
